Public Class UK
    ...
    Private Sub UK_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Novi Then
            'Dim tr As Skrlin.DataSet4.UKRow
            'tr = DataSet4.UK.NewUKRow
            'DataSet4.UK.AddUKRow(tr)
            'UKTableAdapter.Update(DataSet4.UK)
            UKBindingSource.AddNew()
            'IDTextBox.Text = Me.InfekcijaTableAdapter.ScopeIdentity
            UK_ID = IDTextBox.Text
            RegistarskiBRTextBox.Text = P.RegistarskiBR
        Else
            Me.UKTableAdapter.FillByID(Me.DataSet4.UK, UK_ID)
        End If
    ...
    Private Sub Zapamti_Click(sender As Object, e As EventArgs) Handles Zapamti.Click
        Me.Validate()
        Me.UKBindingSource.EndEdit()
        UKTableAdapter.Update(Me.DataSet4.UK)
    End Sub
